  ...
  return (
    <aside id='side-bar' className="sidebar">
      ...
      <nav >
        ...
        <span style={{ display: "flex", gap: "8px", position: "absolute", bottom: "10px", left: "40px",fontSize:"11px",display:"flex",alignItems:"center" ,fontWeight:"600", color:"rgb(145, 145, 134)"}}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#000000" fill="none">
